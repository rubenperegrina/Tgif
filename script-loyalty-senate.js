...
function generatablalest(members) {
    ...
    var tabla = "<h3>Least Engaged (Bottom   10% Loyalty)</h3><table class='table table-hover'><tbody><th>Name</th><th>No. Party Votes </th><th> % Party Votes</th>";
...
function generartablamost(members){
    ...
    var tabla = "<h3>Most Engaged (Top 10% Loyalty)</h3><table class='table table-hover'><tbody><th>Name</th><th>No. Party Votes </th><th> % Party Votes</th>";
